#  R Script Template - January 2019
#
###
...
# Script Purpose:  This script is used to transfor the standard JIRA csv export with multiple component, 
#           links and label fields into single fields for each column and cleans up the data.
# input:    Jira export tickets.csv
